...
def _build_one_round_computation(
  ...
  dataset_type = collections.OrderedDict([
      ('train', tff.SequenceType(dummy_model_for_metadata.input_spec)),
      ('test', tff.SequenceType(dummy_model_for_metadata.input_spec))
  ])
  dataset_type = tff.to_type(dataset_type)
